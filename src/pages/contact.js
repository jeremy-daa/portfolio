...
export default function About() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.ok) {
      ...
      toast.success("📫 Got it, will get back asap.", {
        position: "top-right",
        autoClose: 5000,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Have questions or a project idea? Reach out to me for innovative web solutions and creative digital experiences. Let’s connect and bring your ideas to life!"
        />
      </Head>
      ...
      >
        <Layout className="pt-16">
          <AnimatedText
            text="Your Next Project Awaits – Let’s Start the Conversation! 📬"
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8 relative items-center justify-center rounded-2xl rounded-br-2xl border border-solid border-dark bg-light p-6 shadow-2xl dark:border-light dark:bg-dark xs:p-4">
            ...
            <div className="col-span-4 flex flex-col items-start justify-start xl:col-span-4 md:order-1 md:col-span-8">
              ...
              <p className="">
                ...
                hello – I’m here to help! Fill out the form, and I’ll get back
                to you soon.
              </p>
            </div>
